	...
	return (
		<div className="w-full flex flex-col md:flex-row items-center justify-between gap-8 px-4 sm:px-8 lg:px-16 py-8">
			<div className="w-full md:w-1/2 flex flex-col items-start justify-center gap-8 mb-10">
				...
				<div className="flex flex-col sm:flex-row items-start justify-start gap-4 mb-6 w-full">
					<a href="https://jazaa.recatch.cc/meeting/utxnirulve" className="w-full sm:w-auto">
						<Button variant="default" className="text-base sm:text-lg px-4 sm:px-6 py-2 sm:py-3 w-full" onClick={() => track('Free Demo')}>Get a Free Demo</Button>
					</a>
					<a href="mailto:hello@jazaa.co" className="w-full sm:w-auto">
						<Button variant="secondary" className="text-base sm:text-lg px-4 sm:px-6 py-2 sm:py-3 w-full" onClick={() => track('Contact Us')}>Contact Us</Button>
					</a>
			...
			<div className="w-full md:w-1/2 flex justify-center items-center mt-8 md:mt-0">
				<div className="hidden md:block bg-gray-200 p-2 rounded-lg shadow-lg w-full max-w-[320px]">
					<div className="relative">
						<video
							width="100%"
							height="auto"
